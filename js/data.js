  ...
  days: [
    {
      ...
      hotel: {
        name: "🏨 连云港海滨希尔顿欢朋酒店（高档型）",
        area: "连云港连云区海滨大道",
        tip: "高档型海景房，步行到海边5分钟。五一约800-1200/晚，含自助早餐。提前预订！",
        nav: { name: "连云港海滨希尔顿欢朋酒店", address: "连云港市连云区海滨大道", lnglat: [119.4608, 34.7556] }
      },
      schedule: [
        {
          time: "06:30",
        ...
        },
        {
          time: "19:30",
          title: "入住希尔顿欢朋酒店",
          desc: "高档型海景房，步行到海边5分钟。放下行李后可以去海边散步",
          icon: "🏨",
          type: "hotel",
          nav: {
            name: "连云港海滨希尔顿欢朋酒店",
    ...
    },
    {
      ...
      driveTime: "约2小时",
      hotel: {
        name: "🏨 你好酒店(日照岚山银座商城多岛海店)",
        area: "日照岚山区银座商城",
        tip: "你好酒店连锁，位置便利，到多岛海景区很近。五一约400-600/晚，连住2晚",
        nav: { name: "你好酒店日照岚山银座商城多岛海店", address: "日照市岚山区银座商城", lnglat: [119.5389, 35.4187] }
      },
      schedule: [
        {
          time: "08:00",
          title: "起床早餐",
          desc: "希尔顿酒店自助早餐，吃完收拾行李退房",
          icon: "🌅",
          type: "prepare"
        },
        {
        ...
        },
        {
          time: "14:30",
          title: "出发日照（小庆驾驶）",
          desc: "连云港 → 日照，车程约2小时。小庆驾驶，香香替补",
          icon: "🚗",
          type: "drive",
          nav: {
            name: "你好酒店日照岚山银座商城多岛海店",
            address: "日照市岚山区银座商城",
        ...
        },
        {
          time: "16:30",
          title: "抵达日照，入住酒店",
          desc: "你好酒店(岚山银座商城店)，位置便利，到多岛海景区很近",
          icon: "🏨",
          type: "hotel",
          nav: {
            name: "你好酒店日照岚山银座商城多岛海店",
        ...
        },
        {
          time: "17:00-18:30",
          title: "多岛海景区",
          desc: "酒店附近，步行或短途车程。海边散步、看日落",
          icon: "🌊",
          type: "sight",
          tips: ["离酒店很近，方便", "傍晚光线适合拍照", "人相对较少"]
        },
        {
          time: "19:00",
          title: "日照晚餐",
          desc: "海鲜水饺、鲅鱼饺子、本地小海鲜",
          icon: "🥟",
          type: "food",
          foods: ["海鲜水饺", "鲅鱼饺子", "本地小海鲜拼盘"]
        },
        {
          time: "20:30",
          title: "回你好酒店休息",
          desc: "回你好酒店休息，为明天日照深度游蓄力",
          icon: "🌙",
          type: "rest"
        }
      ]
    ...
    },
    {
      ...
      hotel: {
        name: "🏨 汉庭酒店(徐州苏宁广场店)",
        area: "徐州市中心苏宁广场",
        tip: "汉庭连锁，市中心位置，步行到富国街夜市5分钟。五一约400-600/晚",
        nav: { name: "汉庭酒店徐州苏宁广场店", address: "徐州市鼓楼区苏宁广场", lnglat: [117.1923, 34.2612] }
      },
      schedule: [
        {
          time: "07:00",
        ...
        },
        {
          time: "14:00",
          title: "入住汉庭酒店",
          desc: "汉庭酒店(徐州苏宁广场店)，市中心位置，步行到富国街夜市5分钟。稍作休整",
          icon: "🏨",
          type: "hotel",
          nav: {
            name: "汉庭酒店徐州苏宁广场店",
